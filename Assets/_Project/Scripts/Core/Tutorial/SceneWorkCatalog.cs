    ...
    public static class SceneWorkCatalog
    {
        ...
        private static IReadOnlyList<SceneWorkDefinition> BuildOrderedScenes()
        {
            var ordered = new[]
            {
                ...
                Define(3, TutorialSceneCatalog.PostChickenCutsceneSceneName, "Assets/_Project/Scenes/Tutorial_PostChickenCutscene.unity", "Post-Chicken Cutscene", "Own the short bridge after the chase and tee up the tools arc.", SceneWorkKind.Cutscene, TutorialSceneCatalog.MidpointPlaceholderSceneName),
                Define(4, TutorialSceneCatalog.MidpointPlaceholderSceneName, "Assets/_Project/Scenes/Tutorial_MidpointPlaceholder.unity", "Tool Bridge Placeholder", "Own the lightweight placeholder story beat that preserves the structure between minigames.", SceneWorkKind.Cutscene, TutorialSceneCatalog.FindToolsSceneName),
