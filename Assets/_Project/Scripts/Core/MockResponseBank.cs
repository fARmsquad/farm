...
namespace FarmSimVR.Core
{
    ...
    public static class MockResponseBank
    {
        private static readonly Dictionary<string, string[]> Responses = new()
        {
            ["Old Garrett"] = new[]
            {
                "{\"response\":\"Well now, ain't seen you around these parts before! Name's Garrett. I sell cattle, pigs, sheep, and horses from these pens—honest stock, fair price. What are you lookin' for?\",\"options\":[\"I'm new here. What can you tell me about the town?\",\"What animals do you have today?\",\"Just passing through, old timer.\",\"Goodbye.\"]}",
                "{\"response\":\"This here's a good town. Mira's bakery—best bread this side of the river. Young Pip's got the fruit and veg stall right over yonder. And my pens? That's where folks come when they need a good cow or a steady horse.\",\"options\":[\"Sounds like a lovely place. How long have you lived here?\",\"Any trouble around here I should know about?\",\"Where can I get something to eat?\",\"Goodbye.\"]}",
            ...
            ["Young Pip"] = new[]
            {
                "{\"response\":\"Hey hey! You're new! I'm Pip—I run the fruit-and-veg stall. Tomatoes are perfect today. Want to hear the latest news while you browse?\",\"options\":[\"Sure, what's the latest?\",\"You seem to know a lot about this place.\",\"Where do you get berries for Mira?\",\"Goodbye.\"]}",
